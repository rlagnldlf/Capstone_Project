...
스팀은 세계 최대 규모의 전자 소프트웨어 유통망입니다. 스팀 클라이언트를 통해 게임을 구입하고 관리할 수 있으며 다양한 커뮤니티 기능을 통해 다른 유저들과 소통할 수 있습니다. 현재 약 5만개의 게임을 서비스하고 있으며 가입 계정이 10억 개를 돌파하고 월 평균 사용자가 9천만명을 넘는 등 명실상부한 ESD(전자 소프트웨어 유통망) 업계의 1인자입니다.[[1](https://www.hobbyspace.org/post/606/worldwide-game-platform-steam/)]
FPS는 First Person Shooter의 약자로, 플레이어가 게임 세계를 주인공의 시점에서 바라보며 진행하는 게임 장르입니다. 이는 주로 총기를 사용하여 적을 격파하고 임무를 수행하는 게임으로 알려져 있습니다. FPS 게임은 빠른 반응과 정확한 조준이 요구되며, 주로 플레이어의 플레이 스킬과 전술적 사고를 시험하는 요소를 포함합니다.
### 1.2 게임 리뷰의 영향력
